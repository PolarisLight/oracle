...
from config.config_cifar_pcl import config as config
import models.glmc_resnet as models
...
if __name__ == '__main__':
    opt = ArgumentParser()
    opt.add_argument('--task', type=str, default='SSM', help='task name')
    opt.add_argument('--model', type=str, default='ResNet_GLMC', help='model name')
