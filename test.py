...
def Normal_Mode():
    ...
    opt.add_argument('--model', type=str, default='ResNet_MoE_Gated', help='model name')
    ...
    opt.add_argument('--save_log', type=bool, default=1, help='save log')
    opt = opt.parse_args()
    set_seed(opt.seed)
    ...
    args.train.resume = "Log/oracle-20k/moe_lbl/best_checkpoint.pt"
    main(args)
