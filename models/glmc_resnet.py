...
@core_module
class ResNet_Proto(nn.Module):

    def __init__(self,args)->None:
        super().__init__()
        self.args = args
        self.model = ResNet_modify(BasicBlock_s, [5, 5, 5], num_classes=args.model.num_classes)
        self.proto = HardNegativeMining_Proto_Enhanced(num_classes=args.model.num_classes, 
                                                       feature_dim=256, momentum=0.9, 
                                                       temperature=0.07, k=3, 
...
class ResNet_SSMloss(nn.Module):
    ...
    def __init__(self,args)->None:
        ...
        self.loss = MambaSSMLoss(num_classes=args.model.num_classes,alpha=args.core_params.mamba_alpha,label_dis=args.label_dis)
